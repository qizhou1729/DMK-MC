...
static inline void monomial_nodes_1d(int nnodes, std::vector<double>& nodes, double a = 0, double b = 1) {
...
static inline void monomial_basis_1d(int order, const std::vector<double>& x, std::vector<double>& y,
...
static inline void monomial_interp_1d(int order, int nnodes, std::vector<double>& fn_v, std::vector<double>& coeff,
                                      double a = 0, double b = 1) {
...
PolyFun<Real> approximate_fourier_poly(double c, int order) {
    ...
    auto f = [](double lambda, double c0, double c, double x) {
        double val = 2 * M_PI *lambda * prolate0_eval(c, x) / c0;
        return val;
    };
